...
<?php else: ?>
<a id="logo" href="<?php echo $this->baseUrl?>" title="<?php echo $this->getSitename() ?>"><img class="logo" src="<?php echo $this->baseUrl ?>/templates/td_education/images/logo/logo.png" style="border:0;" alt="" /></a>
<?php endif; ?>
<?php } else { ?>
<div id="logo-text">
